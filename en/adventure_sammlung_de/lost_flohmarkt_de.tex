...
\begin{npcBox}[title=Jonas Ohnesorg]
    ...
    \begin{aspects}
    \item \aspect[High Concept]{Liebt die Tiere mehr als sie ihn lieben}
    \item \aspect[Trouble]{Irgendwas ermutigt andere immer, seine Tiere unsachgemäß anfassen zu wollen}
    \item \aspect[Relationship]{Ist in Antigone verliebt}
    \item \aspect[Aspect]{TODO}
    \end{aspects}
...
\begin{npcBox}[title=Gustav Müller]
    ...
    \begin{aspects}
    \item \aspect[High Concept]{Perfekt organisierter Küchengeneral}
    \item \aspect[Trouble]{Hart zu sich selbst - bis zum umfallen}
    \item \aspect[Relationship]{Er hat keine engeren Beziehungen zu Menschen}
    \item \aspect[Aspect]{TODO}
    \end{aspects}
...
\section{Funk und Kommunikation: Name: Antigone Freitag}
...
\newpage
\begin{npcBox}[title=Antigone Freitag]

    \begin{aspects}
    \item \aspect[High Concept]{Funkerin und Soziale Enzyklopädie}
    \item \aspect[Trouble]{Kennt fast jeden eng - hat aber oft keine Ahnung wie sie aussehen}
    \item \aspect[Relationship]{Dadurch, dass sie jeden sehr gut kennt, hat sie niemanden speziellen}
    \item \aspect[Aspect]{TODO}
    \end{aspects}
...
\begin{npcBox}[title=Laura, Gaianistin]
    ...
    \begin{aspects}
    \item \aspect[High Concept]{Beginnende Gaianistin}
    \item \aspect[Trouble]{Die Schuhe sind zu groß}
    \item \aspect[Relationship]{Sie hat sich frisch der Flohmarkt Gruppe angeschlossen und kennt noch niemanden}
    \item \aspect[Aspect]{Frisch den weg gefunden, hoch begeistert und noch stoplernd}
    \end{aspects}
