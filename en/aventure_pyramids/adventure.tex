...
\begin{npcBox}[title=Norm: Chris]
    ...
    \begin{stunts}
    \item \stunt{Improvising}{Gets +2 on intimidation if the environment can be wrapped into a horror story}
    \end{stunts}
...
\begin{npcBox}[title=Pioneer: Fixit]
    ...
    \begin{stunts}
    \item \stunt{Improvising}{Using my tuned slinhshot I get +2 on shooting.}
    \end{stunts}
    ...
    Fixit is constantly tinkering. Repairing and improving existing devices is Fixit's life.
...
\begin{npcBox}[title=Pioneer: Drop-and-run]
    ...
    \begin{aspects}
    \item \aspect[High Concept]{Decontamination expert at the DOC (decontamination operation center)}
    \item \aspect[Trouble]{Hypochondriac and paranoid - the reason D-A-R is still alive}
    \item \aspect[Aspect]{I extend my protective instict to cover my friends}
    ...
    \begin{stunts}
    \item \stunt{Improvising}{When fleeing from danger I get +2 on Athletics.}
    \end{stunts}
...
\begin{npcBox}[title=Lost: Falko]
    ...
    \begin{stunts}
    \item \stunt{Improvising}{Gets +2 on Burglary when picking locks}
    \end{stunts}
...
\begin{npcBox}[title=Lost: Rocky]
    ...
    \begin{stunts}
    \item \stunt{Improvising}{Can use Notice instead of Empathy to judge a person Rocky knows for more than one hour.}
    \end{stunts}
