...
Norms life in retrofitted cities with added solar panels, green parks, small streams of water and lakes. Everything is quite idyllic but you can still see the original buildings from the 2020 under the green walls.
As modern Nom tech is built based on templates many items, clothes, fashion and architecture looks identical. Those templates can be personalised and smart people do that. But they will never achieve the creative chaos the Pioneers have.

The cities are knows as "hive cities", the Norm society is also quite often called a "hive". The reason for this is the tight and close coordination this society has.

This society is coordinated by AIs (one per town) with goal to improve quality of life for the inhabitants.
To measure this quality of life every Norm carries a "hive controller" which is a communication device with AR interface. This is also the main tools to do their magic: "hive control".
...
Based on available templates the AI will coordinate factories and Norm contractors (very spezialised ones) to build and deliver the customized request.
...
Despite that, some chaos in the towns is created by the plants and animals that were allowed to spread.
...
Norm society depends on a storage building sized AI controller with communication interfaces in the city.

To spread Norm society to new towns the Norms normally start with shipping containers with AI, communication interfaces and power. These "seed hives" have limited capability and a to bootstrap a new society. When set up they will establish a radio link to a partner city hive and start creating an inventory of local services and people in their area.
