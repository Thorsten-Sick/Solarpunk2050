...
They prefer tactical outdoor clothing. Some of it may be military or survival clothing. Most of it has been recycled and repaired several times.
...
\begin{losttalk}[title=Not Reading the Classics]
    \begin{itemize}
        \item \npcquote{Lost}{We leave in two days. So I am making a final check of this garden. You can help. This plant is a weed, just pull it up and put it over there.}
        \item \npcquote{Pioneer}{You're leaving? Why tend the garden?}
        \item \npcquote{Lost}{We do not harvest!}
        \item \npcquote{Norm}{Was that a joke?}
        \item \npcquote{Lost}{More like a quote, a modified one. So there is this book.}
        \item \npcquote{Pioneer}{Don't read books.}
        \item \npcquote{Norm}{Is there a film?}
        \item \npcquote{Lost}{Yes, well, but...this is also weed. Let's keep pulling weeds.}
    \end{itemize}
\end{losttalk}
...
\index{Eat the Rich Festivals!Lost}
