...
\chapter {Write your own adventures}
...
Solarpunk 2050 is set in a realistic world. The tech level is not absurd. And the locations are taken from real towns, cities, landscapes and areas. A map of locations already covered can be found here:\newline

\href{https://solarpunk2050.com/map.php}{https://solarpunk2050.com/map.php} \newline
...
\section{Motivation for the protagonists}
